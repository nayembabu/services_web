...
--
-- Host: localhost:3306
-- Generation Time: Feb 19, 2020 at 01:48 PM
...
--
-- Table structure for table `customer_full`
--

CREATE TABLE `customer_full` (
  `cus_iid` int(100) NOT NULL,
  `cus_full_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cus_mobile_no` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `cus_email` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `div_iid` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `dist_idd` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `upazilla_iiidd` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `union_iddi` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `parmanent_addres` longtext COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `customer_full`
--

INSERT INTO `customer_full` (`cus_iid`, `cus_full_name`, `cus_mobile_no`, `cus_email`, `div_iid`, `dist_idd`, `upazilla_iiidd`, `union_iddi`, `parmanent_addres`) VALUES
(1, 'adasd', '01819084855', 'admin@hml.com', '2', '43', '75', '1488', 'sdf dfdsfsdfsd fsdf sdf sdf sdf ds fsdfsd fsfrwerwerewsdfx    sdf dsxcvcxvxc vxcv cx vfs df  ds fdsf');
...
INSERT INTO `districts` (`dis_id`, `division_id`, `dis_name`, `dis_bn_name`, `lat`, `lon`, `website`) VALUES
...
INSERT INTO `divisions` (`div_id`, `div_name`, `div_bn_name`) VALUES
(1, 'Barishal', 'বরিশাল'),
...
--
-- Table structure for table `nid_request`
--

CREATE TABLE `nid_request` (
  `id` int(100) NOT NULL,
  `cus_inq_id` varchar(100) DEFAULT NULL,
  `query_numbr` varchar(100) DEFAULT NULL,
  `requ_time_stamp` varchar(100) DEFAULT NULL,
  `status` int(1) DEFAULT '0',
  `img_upload_url` text,
  `img_uplaod_time` varchar(100) DEFAULT NULL,
  `this_date` varchar(100) DEFAULT NULL,
  `admn_unq_id` int(100) DEFAULT NULL,
  `service_unq_idd` int(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `nid_request`
--

INSERT INTO `nid_request` (`id`, `cus_inq_id`, `query_numbr`, `requ_time_stamp`, `status`, `img_upload_url`, `img_uplaod_time`, `this_date`, `admn_unq_id`, `service_unq_idd`) VALUES
(5, '1', NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `service_info_s`
--

CREATE TABLE `service_info_s` (
  `service_uniq_iddi` int(11) NOT NULL,
  `service_name` longtext COLLATE utf8_unicode_ci NOT NULL,
  `service_rate` int(200) NOT NULL,
  `description` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

--
-- Dumping data for table `service_info_s`
--

INSERT INTO `service_info_s` (`service_uniq_iddi`, `service_name`, `service_rate`, `description`) VALUES
(1, 'NID Online Copy', 50, '');
...
INSERT INTO `unions` (`un_id`, `upazila_id`, `un_name`, `un_bn_name`, `lat`, `lon`) VALUES
(1, 226, '', 'আমলাব', 0, 0),
(2, 226, '', 'বাজনাব', 0, 0),
(3, 226, '', 'বেলাব', 0, 0),
...
CREATE TABLE `upazilas` (
  `up_id` int(2) UNSIGNED NOT NULL,
  `district_id` int(2) UNSIGNED NOT NULL,
  `up_name` varchar(30) NOT NULL,
  `up_bn_name` varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `upazilas` (`up_id`, `district_id`, `up_name`, `up_bn_name`) VALUES
...
CREATE TABLE `users` (
  ...
  `cus_iniq_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `u_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `users` (`id`, `ip_address`, `username`, `password`, `email`, `activation_selector`, `activation_code`, `forgotten_password_selector`, `forgotten_password_code`, `forgotten_password_time`, `remember_selector`, `remember_code`, `created_on`, `last_login`, `active`, `first_name`, `last_name`, `company`, `phone`, `cus_iniq_id`, `u_name`) VALUES
(1, '127.0.0.1', 'administrator', '$2y$12$IqFyrEBMJuIXyPVLSk3f3Omldfo2JaprRI5hIXfHRk8Soo3jPcZ1m', 'admin@admin.com', NULL, '', NULL, NULL, NULL, NULL, NULL, 1268889823, 1582023878, 1, 'Admin', 'istrator', 'ADMIN', '0', '', ''),
(2, '', NULL, '$2y$10$6BnaqdEuskuLuUVsapXgcunJU7FJgdtdRE4fYID3YxNnN6H8AjSku', 'pub@pub.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 1582024048, 1, NULL, NULL, NULL, NULL, '', ''),
(3, '', NULL, '$2y$10$7dLSraapJvyqVxXD.3NnzOMK2vnOo/B1Fp4CilDXl.BzXxrOu.Ypy', 'admin@hml.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1582106208, 1582110493, 1, NULL, NULL, NULL, NULL, '1', 'asdasd');
...
--
-- Indexes for table `customer_full`
--
ALTER TABLE `customer_full`
  ADD PRIMARY KEY (`cus_iid`);
...
--
-- Indexes for table `nid_request`
--
ALTER TABLE `nid_request`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `service_info_s`
--
ALTER TABLE `service_info_s`
  ADD PRIMARY KEY (`service_uniq_iddi`);
...
--
-- AUTO_INCREMENT for table `customer_full`
--
ALTER TABLE `customer_full`
  MODIFY `cus_iid` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `districts`
--
ALTER TABLE `districts`
  MODIFY `dis_id` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT for table `divisions`
--
ALTER TABLE `divisions`
  MODIFY `div_id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
-- AUTO_INCREMENT for table `nid_request`
--
ALTER TABLE `nid_request`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `service_info_s`
--
ALTER TABLE `service_info_s`
  MODIFY `service_uniq_iddi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `unions`
  MODIFY `un_id` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2351;

--
-- AUTO_INCREMENT for table `upazilas`
--
ALTER TABLE `upazilas`
  MODIFY `up_id` int(2) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=493;
